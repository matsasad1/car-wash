Shader "Custom/CelShaderWithFresnel"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float4 fresnelColorProp = UNITY_ACCESS_INSTANCED_PROP(Props, _FresnelColor);
                float fresnelPower = UNITY_ACCESS_INSTANCED_PROP(Props, _FresnelPower);
                float fresnelIntensity = UNITY_ACCESS_INSTANCED_PROP(Props, _FresnelIntensity);
                ...
                fixed3 fresnelCol = fresnelColorProp.rgb * fresnel * fresnelIntensity;

                // Add Fresnel over cel shading
                lighting += fresnelCol;
